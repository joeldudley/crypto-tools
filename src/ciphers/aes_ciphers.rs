...
mod tests {
    ...
    use crate::ciphers::aes_ciphers::{decrypt_cbc_mode, decrypt_ecb_mode, is_encrypted_using_aes_ecb_mode};
    ...
    fn can_detect_ecb_mode() {
        ...
        let ecb_ciphertext = ciphertexts
            .iter()
            .find(|ciphertext| is_encrypted_using_aes_ecb_mode(ciphertext))
            .unwrap();
